...
namespace WindowsFormsApplication1
{
    ...
    {
        //declara uma var (objeto) do tipo frmCadastroCliente
        frmCadastroCliente frmCliente; //var da classe
        //passando por parâmetro o form frmCadastroCliente
        //construtor recebe como parâmetro declara uma variável 
        //(objeto) do tipo frmCadastroCliente
        public frmConsultaCliente(frmCadastroCliente frmCliente)
        {
            //var da classe = parametro do construtor
